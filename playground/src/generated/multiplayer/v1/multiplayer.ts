...
export namespace multiplayer.v1 {
  ...
  export class Message extends pb_1.Message {
    ...
    static fromObject(data: { type?: MessageType; data?: string; client_id?: string }): Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (typeof this.data === "string" && this.data.length) writer.writeString(2, this.data);
      if (typeof this.client_id === "string" && this.client_id.length) writer.writeString(3, this.client_id);
  ...
  export class SendMessageRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.message !== undefined) writer.writeMessage(2, this.message, () => this.message.serialize(writer));
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class GetMessageStreamRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMessageStreamRequest {
      const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
        message = new GetMessageStreamRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          default:
